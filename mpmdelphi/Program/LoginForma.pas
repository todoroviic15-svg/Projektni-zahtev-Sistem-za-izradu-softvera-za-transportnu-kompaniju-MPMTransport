...
uses
  ...
  PocetnaStranica, FMX.Edit, FMX.Objects, FMX.StdCtrls, FMX.Controls.Presentation,
...
uses MenadzerForma, AdministratorForma, DispecerForma,KlijentForma,VozacForma;
